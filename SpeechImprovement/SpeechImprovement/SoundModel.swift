...
let toneClassifier1 = try! SpeechImprovement_ML_14(configuration: defaultConfig)
...
let classifyToneSoundReq1 = try! SNClassifySoundRequest(mlModel: toneClassifier1.model)
